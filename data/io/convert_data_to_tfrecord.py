...
FLAGS2["data_dir"] = os.path.abspath(os.path.join(FLAGS2["root_dir"],'DateSet','VOC2007','TrainVal','VOCdevkit2007','VOC2007'))

tf.app.flags.DEFINE_string('VOC_dir', FLAGS2["data_dir"], 'Voc dir')   #VOC目录地址，修改
...
def read_xml_gtbox_and_label(xml_path):
    ...
    '''
    a list contains gtboxes and labels, shape is [num_of_gtboxes, 5],
    [xmin, ymin, xmax, ymax, label] in a per row
    '''
...
def convert_pascal_to_tfrecord():
    ...
    xmls = [os.path.join(xml_path, f).replace('jpg', 'xml') for f in os.listdir(image_path)]
