...
def next_batch(dataset_name, batch_size, shortside_len, is_training):
    ...
    if is_training:
        pattern = os.path.join(cfgs.ROOT_PATH,'data','tfrecords', dataset_name + '_train.tfrecord')
    else:
        pattern = os.path.join(cfgs.ROOT_PATH,'data','tfrecords', dataset_name + '_test.tfrecord')
